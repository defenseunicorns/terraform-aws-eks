...
In secure mode, the EKS cluster does not have a public endpoint. To connect to it, you'll need to tunnel through the bastion host.
...
aws eks --region $region update-kubeconfig --name $(terraform output -raw eks_cluster_name)
